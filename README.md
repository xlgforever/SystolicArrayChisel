...
```sh
git clone git@github.com:xlgforever/SystolicArrayChisel.git
cd SystolicArrayChisel
```
...
#### Commit your changes
```sh
git commit -m 'Starting SystolicArrayChisel'
